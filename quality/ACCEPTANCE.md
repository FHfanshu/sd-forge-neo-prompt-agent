...
| IMAGE-INPUT-001 | 2 | agent | Grounded image analysis and multi-image input | visual-grounding, bilingual-caption, multi-select, clipboard-paste |
...
| UI-FEEDBACK-001 | 10 | ui | Compact lifecycle and process feedback | loading, recovery, process, submission, queue, streaming, post-turn, connection |
