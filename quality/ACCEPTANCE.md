...
| AGENT-TOOLS-001 | 13 | agent | Forge tool authority and freshness | surface, on-demand-reveal, revalidation, freshness, parallel-reads, serialized-writes, danbooru-wiki-default, wiki-navigation, context-pruning |
...
| PROVIDER-TOOLS-001 | 3 | provider | Provider-native tool execution contract | forced-choice, normalization, abort |
...
| UI-FEEDBACK-001 | 13 | ui | Compact lifecycle and process feedback | recovery, process, submission, queue, streaming, context-usage |
