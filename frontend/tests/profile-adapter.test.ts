...
describe("profile migration adapters", () => {
  ...
  it("coerces removed provider modes to the supported remote HTTP contract", () => {
  ...
  it("resolves the active agent among enabled profiles while normalizing a version-one state", () => {
