...
describe("PiPromptAgentRuntime", () => {
  ...
  acceptanceTest("AGENT-TOOLS-001@8", "parallel-reads,serialized-writes", "runs independent read batches concurrently while serializing any batch that contains a write", async () => {
