...
export const FORGE_AGENT_SYSTEM_PROMPT = [
  ...
  "Specialized prompting instructions are loaded on demand instead of living in this system prompt. Before writing or substantially revising canonical Danbooru tags, call load_skill with danbooru_tags. Before writing or revising prompts for an Anima checkpoint, call load_skill with anima_dit. Before constructing multi-character or regional prompts for Forge Couple, call load_skill with forge_couple. Follow the returned guide for the current task.",
